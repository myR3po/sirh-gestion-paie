...
public class CotisationServiceJpaTest {
	...
	public void test_sauvegarder_lister_mettre_a_jour() {
		...
		Cotisation cotisationRecup = cotisationService.lister().stream().filter(c -> c.getCode().equals(cotisation.getCode())).findAny().orElse(null);
		...
		Cotisation cotisationRecup2 = cotisationService.lister().stream().filter(c -> c.getCode().equals(cotisation.getCode())).findAny().orElse(null);
